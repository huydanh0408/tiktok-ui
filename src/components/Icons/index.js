export function DarkModeIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function DownloadTikTokAppIcon({
    width = '11.6rem',
    height = '11rem',
    className,
}) {
...
export function FavoriteIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function LiveCreatorHubIcon({
    width = '2rem',
    height = '2rem',
    className,
}) {
...
export function LiveStudioIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
