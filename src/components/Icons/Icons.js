export function MoonIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function DeviceIcon({ width = '2.6rem', height = '2.6rem', className }) {
    return (
        <svg
            className={className}
            fill="currentColor"
...
export function TiktokLaptopIcon({
    width = '11.6rem',
    height = '11rem',
    className,
}) {
...
export function EllipsisIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function BookmarkIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function LiveBulbIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function LiveIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function LiveSidebarIcon({
    width = '3.2rem',
    height = '3.2rem',
    className,
    solid = false,
...
export function QuestionIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function TiktokCoinIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
